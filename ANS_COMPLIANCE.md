...
FTEST harness: run with `FTEST=1 swift /tmp/combined.swift` (concatenate `TZForth.swift`, `TZForthTests.swift`, `TestTZForth.swift`). Current count: **259/259** TEST6 spot-checks plus block-comment / FLOAD harness tests.
