...
This suite ships inside the TZForth app as:
...
Suite sources (`required-helper*.fth`, etc.) still load from `Resources/Library/…`.

Baseline transcript: `src/HAYES-RESULTS.txt`.
